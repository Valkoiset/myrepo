...
xx <- c(9.20, 6.00, 6.00, 11.25, 11.00, 7.25, 9.7, 13.25, 14.00, 8.00)
histogram( ~ xx | "Histogram", type = "count")
...
# lattice ----------------------------------------------------------
testeAxel <- factor(c(rep("xx1",20),rep("xx2",40),rep("xx3",31)))
numbers <- c(xx1,xx2,xx3)
bwplot(numbers ~ testeAxel)


# Please change all charts created in module http://jolej.linuxpl.info/VIS_3.html to lattice charts.
